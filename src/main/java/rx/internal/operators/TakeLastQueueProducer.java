...
final class TakeLastQueueProducer<T> implements Producer {
    ...
    public TakeLastQueueProducer(NotificationLite<T> n, Deque<Object> q,
    ...
    private static final AtomicLongFieldUpdater<TakeLastQueueProducer> REQUESTED_UPDATER = AtomicLongFieldUpdater
            .newUpdater(TakeLastQueueProducer.class, "requested");
        ...
        if (requested == Long.MAX_VALUE) {
            ...
            if (previousRequested == 0) {
                while (true) {
                     ...
                     * volatile `requested` value during the loop itself. If it
                     * is touched during the loop the performance is impacted
                     * significantly.
                     */
