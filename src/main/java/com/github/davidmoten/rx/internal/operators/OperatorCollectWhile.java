...
public class OperatorCollectWhile<R, T> implements Operator<R, T> {
    ...
    public OperatorCollectWhile(Func0<? extends R> factory, Func2<? super R, ? super T, ? extends R> collector,
