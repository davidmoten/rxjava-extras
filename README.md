...
* `Transformers.decode`
* [`Transformers.onBackpressureBufferToFile`](#transformersonbackpressurebuffertofile) - uses MapDB to buffer items to cache backed by disk, supports weak/soft/hard/LRU reference cache
